...
from .utils.cuda import model_to_device
...
# from .pipeline_base import PromptForClassification, PromptForGeneration
# from .pipeline_base import PromptDataLoader
from .prompts import *
from .utils.logging import logger
from .utils.metrics import classification_metrics, generation_metric
...
class BaseRunner(object):
    ...
    """
    from .pipeline_base import PromptForClassification, PromptDataLoader, PromptForGeneration
    def __init__(self,
...
class ClassificationRunner(BaseRunner):
    ...
    Args:
        ...
        loss_function (:obj:`Callable`, optional): The loss function in the training process.
    """
    from .pipeline_base import PromptForClassification, PromptDataLoader
    def __init__(self,
                 model: PromptForClassification,
                 config: CfgNode = None,
                 train_dataloader: Optional[PromptDataLoader] = None,
...
class GenerationRunner(BaseRunner):
    ...
    Args:
        ...
        config (:obj:`CfgNode`): A configuration object.
    """
    from .pipeline_base import PromptForGeneration, PromptDataLoader
    def __init__(self,
